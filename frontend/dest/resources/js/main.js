  ...
  methods.data = {
    ...
    showContacts: function() {
      ...
      contacts.forEach(function(contact, index) {
        ...
        if (
          !elements.contactItemsUnit.querySelector(
    ...
    removeContactItemFromDomNode: function(contactId) {
      console.log(elements.contactItemsUnit);
